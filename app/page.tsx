    ...
    <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0">
      <div className="lg:flex lg:justify-between lg:gap-4">
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
          <div>
            <Link href="/">
              <h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">Bryan Borgeson</h1>
            </Link>
            <h2 className="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">Senior Software Engineer</h2>
            <p className="mt-4 max-w-xs leading-normal">
              I write code to solve problems. And sometimes, it even works.
            </p>
          </div>
          ...
          <ul className="ml-1 mt-8 flex items-center" aria-label="Social links">
            ...
            <li className="mr-3 text-xs shrink-0">
              <a href="https://linkedin.com/in/bryborge" target="_blank">
            ...
            <li className="mr-3 text-xs shrink-0">
              <a href="https://x.com/bryborge" target="_blank">
            ...
            <li className="mr-3 text-xs shrink-0">
              <a href="https://instagram.com/bryborge" target="_blank">
